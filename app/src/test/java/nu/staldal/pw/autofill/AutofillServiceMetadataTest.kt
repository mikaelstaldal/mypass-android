 ...
 * regardless would be releasing a password to a page pw cannot identify, at the
...
class AutofillServiceMetadataTest {
    ...
    @Test fun declaresTheSettingsActivityItIsFoundBy() {
        assertTrue(withoutComments.contains("android:settingsActivity=\"nu.staldal.pw.MainActivity\""))
    }
