...
class ValidationTest {
    ...
    fun rejectsEmptyName() {
        val e = assertThrows(PwException.InvalidInput::class.java) {
    ...
    fun emptyUrlOrRealmIsRejectedRatherThanStored() {
        assertThrows(PwException.InvalidInput::class.java) { Validation.validateUrl("") }
        assertThrows(PwException.InvalidInput::class.java) { Validation.validateRealm("") }
    }
