 ...
 * *outside* the browser, in MyPass's own process, which the browser cannot see or
...
class AutofillAuthActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uri = intent.data
        val token = uri?.takeIf { it.scheme == "mypass-autofill-auth" && it.authority == "request" }
    ...
    private fun respond(structure: AssistStructure, inline: InlineRequest?) {
        ...
        // The unlock offer said only "MyPass has something here"; whether anything
