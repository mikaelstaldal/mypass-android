 ...
 * JSON string, exactly like the desktop `MyPass`'s `Secret`.
 *
 ...
 * wiped (the JSON parser would have made its own copies anyway). mypass-android
...
internal object SecretSerializer : KSerializer<Secret> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("nu.staldal.mypass.vault.Secret", PrimitiveKind.STRING)
