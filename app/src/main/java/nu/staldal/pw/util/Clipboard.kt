 ...
 * let an app in the background read the clipboard. While pw is foregrounded,
 * a listener and a private tag in the clip description verify that the clip is
 * still ours. A clear requested in the background is deferred until pw returns
...
object Clipboard {
    ...
    private const val EXTRA_OWNERSHIP_TOKEN = "nu.staldal.pw.extra.CLIP_TOKEN"
