...
class FetchPasswordActivity : FragmentActivity() {
    ...
    private fun returnEntry(query: PasswordQuery, entry: PasswordEntry) {
        ...
        val entries = (application as PwApplication).repository.entriesOrNull()
    ...
    companion object {
        const val ACTION_FETCH_PASSWORD = "nu.staldal.pw.action.FETCH_PASSWORD"
        const val EXTRA_NAME = "nu.staldal.pw.extra.NAME"
        const val EXTRA_URL = "nu.staldal.pw.extra.URL"
        const val EXTRA_REALM = "nu.staldal.pw.extra.REALM"
        const val EXTRA_RESULT_NAME = "nu.staldal.pw.extra.RESULT_NAME"
        const val EXTRA_RESULT_USERNAME = "nu.staldal.pw.extra.RESULT_USERNAME"
        const val EXTRA_RESULT_PASSWORD = "nu.staldal.pw.extra.RESULT_PASSWORD"
        const val EXTRA_RESULT_URL = "nu.staldal.pw.extra.RESULT_URL"
        const val EXTRA_RESULT_REALM = "nu.staldal.pw.extra.RESULT_REALM"
    }
}
