 ...
 *
 * These are the desktop `pw`'s browser-integration matching rules, unchanged:
...
object Matching {
     ...
     * wrong password.
     *
     * This is the desktop `pw`'s `exactly_matching_entries` without its realm
     ...
     * where Rust's `psl` crate, and therefore desktop `pw`, allows the ordinary
     * parent-domain match.
     */
